BaganatorBankLiveOnlyViewMixin = {}
function BaganatorBankLiveOnlyViewMixin:OnLoad()
...
function BaganatorBankLiveOnlyViewMixin:OnHide()
  Baganator.CallbackRegistry:TriggerEvent("SearchTextChanged", "")
  Baganator.UnifiedBags.Search.ClearCache()
end

function BaganatorBankLiveOnlyViewMixin:OnDragStart()
...
function BaganatorBankLiveOnlyViewMixin:OnDragStop()
...
function BaganatorBankLiveOnlyViewMixin:ToggleReagents()
...
function BaganatorBankLiveOnlyViewMixin:ToggleBagSlots()
...
function BaganatorBankLiveOnlyViewMixin:ApplySearch(text)
...
function BaganatorBankLiveOnlyViewMixin:OnEvent(eventName)
...
function BaganatorBankLiveOnlyViewMixin:UpdateBagSlots()
...
function BaganatorBankLiveOnlyViewMixin:OnHide(eventName)
  CloseBankFrame()
end

function BaganatorBankLiveOnlyViewMixin:SetLiveCharacter(character)
  self.liveCharacter = character
end

function BaganatorBankLiveOnlyViewMixin:UpdateForCharacter(character, updatedBags)
  self:UpdateBagSlots()
...
function BaganatorBankLiveOnlyViewMixin:NotifyBagUpdate(updatedBags)
