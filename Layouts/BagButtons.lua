...
BaganatorCachedBagButtonGridMixin = {}
...
function BaganatorCachedBagButtonGridMixin:OnLoad()
...
function BaganatorCachedBagButtonGridMixin:InformSettingChanged(setting)
...
function BaganatorCachedBagButtonGridMixin:RequestContentRefresh()
  self.refreshContent = true
end

function BaganatorCachedBagButtonGridMixin:CompareButtonIndexes(indexes, indexesToUse, newBags)
...
function BaganatorCachedBagButtonGridMixin:MarkBagsPending(section, updatedWaiting)
  for bag in pairs(updatedWaiting[section]) do
    self.waitingUpdate[bag] = true
  end
end

function BaganatorCachedBagButtonGridMixin:RebuildLayout(newBags, indexes, indexesToUse, rowWidth)
...
function BaganatorCachedBagButtonGridMixin:ShowCharacter(character, section, indexes, indexesToUse, rowWidth)
...
function BaganatorCachedBagButtonGridMixin:ApplySearch(text)
  self.SearchMonitor:StartSearch(text)
end

function BaganatorCachedBagButtonGridMixin:OnShow()
...
function BaganatorCachedBagButtonGridMixin:OnHide()
...
BaganatorLiveBagButtonGridMixin = {}

function BaganatorLiveBagButtonGridMixin:OnLoad()
  if Baganator.Constants.IsRetail then
...
function BaganatorLiveBagButtonGridMixin:PreallocateButtons(buttonCount)
...
function BaganatorLiveBagButtonGridMixin:UpdateCooldowns()
  for _, button in ipairs(self.buttons) do
...
function BaganatorLiveBagButtonGridMixin:OnEvent(eventName, ...)
...
function BaganatorLiveBagButtonGridMixin:OnShow()
...
function BaganatorLiveBagButtonGridMixin:OnHide()
...
function BaganatorLiveBagButtonGridMixin:InformSettingChanged(setting)
  if tIndexOf(ReflowSettings, setting) ~= nil then
    self.reflow = true
  elseif tIndexOf(RefreshContentSettings, setting) ~= nil then
    self.refreshContent = true
...
function BaganatorLiveBagButtonGridMixin:RequestContentRefresh()
  self.refreshContent = true
end

function BaganatorLiveBagButtonGridMixin:UpdateLockForItem(bagID, slotID)
...
function BaganatorLiveBagButtonGridMixin:RebuildLayout(indexes, indexesToUse, rowWidth)
  self.buttonPool:ReleaseAll()
...
function BaganatorLiveBagButtonGridMixin:CompareButtonIndexes(indexes, indexesToUse)
  for index, bagID in ipairs(indexes) do
...
function BaganatorLiveBagButtonGridMixin:MarkBagsPending(section, updatedWaiting)
  for bag in pairs(updatedWaiting[section]) do
    self.waitingUpdate[bag] = true
  end
end

function BaganatorLiveBagButtonGridMixin:ShowCharacter(character, section, indexes, indexesToUse, rowWidth)
  if indexesToUse == nil then
    indexesToUse = {}
    for index in ipairs(indexes) do
      indexesToUse[index] = true
...
function BaganatorLiveBagButtonGridMixin:ApplySearch(text)
  self.SearchMonitor:StartSearch(text)
end
